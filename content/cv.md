...
- Proficient in Python, Go, and Nix and have experience writing production code in each.
- Building infrastructure to support cross-compilation of software using Nix and Bazel.
- Building and optimizing CI/CD pipelines for complex production workflows.

## Certifications

### [IBM DevOps and Software Engineering Certificate](https://coursera.org/verify/professional-cert/3RITT13S8MDZ)
### [IBM Applied DevOps Engineering Certificate](https://coursera.org/verify/professional-cert/BCEJZCVC9VRE)
